...
using lawyer.api.appointments.application.UseCases.Example.Delete;
using lawyer.api.appointments.application.UseCases.Example.GetAll;
using lawyer.api.appointments.application.UseCases.Example.GetById;
