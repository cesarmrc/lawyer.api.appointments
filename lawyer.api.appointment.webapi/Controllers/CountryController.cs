...
using lawyer.api.appointment.application.UseCases.Country.Delete;
using lawyer.api.appointment.application.UseCases.Country.GetAll;
using lawyer.api.appointment.application.UseCases.Country.GetById;
