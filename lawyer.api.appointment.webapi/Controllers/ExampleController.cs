...
using lawyer.api.appointment.application.UseCases.Example.Delete;
using lawyer.api.appointment.application.UseCases.Example.GetAll;
using lawyer.api.appointment.application.UseCases.Example.GetById;
