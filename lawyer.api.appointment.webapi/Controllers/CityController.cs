...
using lawyer.api.appointment.application.UseCases.City.Delete;
using lawyer.api.appointment.application.UseCases.City.GetAll;
using lawyer.api.appointment.application.UseCases.City.GetById;
